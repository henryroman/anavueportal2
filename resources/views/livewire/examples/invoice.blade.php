<title>Volt Laravel Dashboard - Invoice</title>
    ...
    <div class="col-12 col-xl-9">
        <div class="card shadow border-0 p-4 p-md-5 position-relative">
            <div class="d-flex justify-content-between pb-4 pb-md-5 mb-4 mb-md-5 border-bottom border-light">
                <img class="image-md" src="../../assets/img/brand/light.svg" height="30" width="30" alt="Rocket Logo">
                <div>
                    <h4>Volt LLC.</h4>
                ...
                <div class="col-sm">
                    ...
                    <div>
                        <ul class="list-group simple-list">
                            ...
                            <li class="list-group-item fw-normal"><a class="fw-bold text-primary" href="#">name@company.com</a></li>
                        </ul> 
                    </div>
                </div>
