        ...
        <li class="nav-item dropdown ms-lg-3">
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="media d-flex align-items-center">
              <img class="avatar rounded-circle" alt="Image placeholder" src="<?php echo e(auth()->user()->avatarUrl() ? auth()->user()->avatarUrl() : '/assets/img/team/profile-picture-5.jpg'); ?>">
              <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                <span class="mb-0 font-small fw-bold text-gray-900"><?php echo e(auth()->user()->first_name ? auth()->user()->first_name . ' ' . auth()->user()->last_name : 'User Name'); ?></span>
              </div>
            </div>
          </a>
          <ul id="profile" class="dropdown-menu dropdown-menu-end dropdown-menu-dark flex-column mx-0 shadow w-220px" data-bs-theme="dark">
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="<?php echo e(route('profile')); ?>">
                
                My Profile
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="<?php echo e(route('billing')); ?>">
                
                Billing
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="<?php echo e(route('security')); ?>">
            ...
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="<?php echo e(route('lock')); ?>">
...
} elseif ($_instance->childHasBeenRendered('caSUxOV')) {
    $componentId = $_instance->getRenderedChildComponentId('caSUxOV');
    $componentTag = $_instance->getRenderedChildComponentTagName('caSUxOV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('caSUxOV');
} else {
    $response = \Livewire\Livewire::mount('auth.logout', []);
    $html = $response->html();
    $_instance->logRenderedChild('caSUxOV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
              </a>
...
</style><?php /**PATH C:\Users\augus\Documents\Anavue frontend\anavuePortal\dashboard\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>