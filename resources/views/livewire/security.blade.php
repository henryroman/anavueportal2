<script>
    document.addEventListener('DOMContentLoaded', function () {
        var options = {
            series: [{
                name: 'Live Users',
                data: @json(array_column($historicUserCounts, 'count'))
            }],
            chart: {
                type: 'bar',
                height: 350,
            ...
            xaxis: {
                categories: @json(array_column($historicUserCounts, 'week')),
                labels: {
                    rotate: -45
                }
            },
...
<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">{{__('Security')}}</h2>
            <p class="mb-0">{{__('All of your dashboard security settings.')}}</p>
        </div>
    </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="small d-flex mt-1">
                                        ...
                                        <div><span class="text-success fw-bolder me-1">{{ number_format($percentageChange, 2) }}%</span> Since last year</div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h3 class="fw-extrabold mb-1">{{ $roleCount }}</h3>
                                    <small class="d-flex align-items-center">
                                        <svg class="icon icon-xxs text-gray-400 me-1" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                        ...
                                        Last role created at {{ $lastRoleCreatedAt }}
                                    </small>
                                </div>
