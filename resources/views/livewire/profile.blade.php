                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input wire:model="user.first_name"
                                        class="form-control @error('user.first_name') is-invalid @enderror" id="first_name"
                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input wire:model="user.last_name"
                                        class="form-control @error('user.last_name') is-invalid @enderror" id="last_name"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.email"
                                        class="form-control @error('user.email') is-invalid @enderror" id="email"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.phone"
                                        class="form-control @error('user.phone') is-invalid @enderror" id="phone"
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.city"
                                        class="form-control @error('user.city') is-invalid @enderror" id="city" type="text"
                                        placeholder="City">
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.country"
                                        class="form-control @error('user.country') is-invalid @enderror" id="country"
                    ...
                    <div class="col-12 mb-4">
                        <div class="card shadow border-0 text-center p-0">
                            ...
                            <div class="card-body pb-5">
                                <img src="{{ auth()->user()->avatarUrl() ? auth()->user()->avatarUrl() : '/assets/img/team/profile-picture-5.jpg'}}"
                                ...
                                <p class="text-gray mb-4">{{  auth()->user()->city ? auth()->user()->city : 'City'}},
                                    {{  auth()->user()->country ? auth()->user()->country : 'Country'}}</p>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    ...
                                    <div class="user-avatar xl-avatar">
                                        @if ($upload)
                                        <img class="rounded avatar-xl" src="{{ $upload->temporaryUrl() }}" alt="change avatar" height="100" width="100">
                                        @else
                                        <img class="rounded avatar-xl" src="{{ auth()->user()->avatarUrl() }}" alt="change avatar" height="100" width="100">
                                        @endif
                                    </div>
                                </div>
