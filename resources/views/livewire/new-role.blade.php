<div>
    <title>Volt Laravel Dashboard - New Role</title>
    <div>
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <h2 class="h4">{{__('Add role')}}</h2>
                <p class="mb-0">{{__('Your role creation template.')}}</p>
            </div>
        </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div>
                            ...
                            <textarea wire:model="description"
                                class="form-control @error('description') is-invalid @enderror" id="description" type="text"
