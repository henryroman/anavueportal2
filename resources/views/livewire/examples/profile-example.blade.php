                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">
                                    ...
                                    <input class="form-control datepicker-input" id="datepicker" type="text" placeholder="YYYY-MM-DD" >
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('user.country') is-invalid @enderror" id="country"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                ...
                                <div class="user-avatar xl-avatar">
                                    <img class="rounded avatar-xl" src="/assets/img/team/profile-picture-5.jpg" alt="change avatar" width="100" height="100">
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-xl-center ms-xl-3">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-md-block text-left">
                                            ...
                                            <div class="text-gray small">JPG, GIF or PNG. Max size of 5MB</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
