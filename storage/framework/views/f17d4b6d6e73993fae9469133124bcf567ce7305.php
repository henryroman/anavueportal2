<title>Volt Laravel Dashboard - Widgets</title>
            ...
            <div class="card-body">
                <div class="row d-block d-xxl-flex align-items-center">
                    ...
                    <div class="col-12 col-xxl-6 ps-xxl-4 pe-xxl-0">
                        <h2 class="fs-5 fw-normal mb-1">Customers</h2>
            ...
            <div class="card-body">
                <div class="row d-block d-xxl-flex align-items-center">
                    ...
                    <div class="col-12 col-xxl-6 ps-xxl-4 pe-xl-0">
                        <h2 class="fs-5 fw-normal mb-1">Revenue</h2>
                        ...
                        <div class="small d-flex mt-1">
                            <svg class="icon icon-xs text-danger" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
    ...
    <div class="col-12 col-xl-8">
        <div class="card card-body border-0 shadow mb-4">
            ...
            <form>
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-gray-800">Save All</button>
                </div>
            </form>
        </div>
        <div class="card card-body border-0 shadow mb-4 mb-lg-0">
            ...
            <div class="col-12 col-sm-6 col-xl-12">
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <div class="d-xl-flex align-items-center">
                        <div>
                            <!-- Avatar -->
                            <img class="rounded avatar-xl" src="../assets/img/profile-cover.jpg" alt="change cover photo">
                        </div>
                        <div class="file-field">
                            <div class="d-flex justify-content-xl-center ms-xl-3">
                                <div class="d-flex">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <div class="progress-wrapper">
                                ...
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 24%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\augus\Documents\Anavue frontend\anavuePortal\dashboard\resources\views/livewire/widgets.blade.php ENDPATH**/ ?>