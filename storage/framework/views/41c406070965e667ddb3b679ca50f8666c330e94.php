                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input wire:model="user.first_name"
                                        class="form-control <?php $__errorArgs = ['user.first_name'];
...
unset($__errorArgs, $__bag); ?>" id="first_name"
                                ...
                                <?php $__errorArgs = ['user.first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                            ...
                            <div class="col-md-6 mb-3">
                                <div>
                                    ...
                                    <input wire:model="user.last_name"
                                        class="form-control <?php $__errorArgs = ['user.last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="last_name"
                                ...
                                <?php $__errorArgs = ['user.last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.date-picker','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>" id="email"
                                        ...
                                        <?php echo e((auth()->user()->id == 1 || auth()->user()->id == 2 || auth()->user()->id == 3) ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                                <?php if(auth()->user()->id == 1 || auth()->user()->id == 2 || auth()->user()->id == 3): ?>
                                    <p class="text-sm-start pt-1 mb-0" style="font-size: 12px">In the demo version email editing is not available for the default users</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.phone"
                                        class="form-control <?php $__errorArgs = ['user.phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="phone"
                                        type="text" placeholder="+12-345 678 910">
                                </div>
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.city"
                                        class="form-control <?php $__errorArgs = ['user.city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input wire:model="user.country"
                                        class="form-control <?php $__errorArgs = ['user.country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="country"
                                        type="tel" placeholder="Country">
                                </div>
                                <?php $__errorArgs = ['user.country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                    ...
                    <div class="col-12 mb-4">
                        <div class="card shadow border-0 text-center p-0">
                            ...
                            <div class="card-body pb-5">
                                <img src="<?php echo e(auth()->user()->avatarUrl() ? auth()->user()->avatarUrl() : '/assets/img/team/profile-picture-5.jpg'); ?>"
                                    class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="User Portrait">
                                <h4 class="h3">
                                ...
                                <p class="text-gray mb-4"><?php echo e(auth()->user()->city ? auth()->user()->city : 'City'); ?>,
                                    <?php echo e(auth()->user()->country ? auth()->user()->country : 'Country'); ?></p>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    ...
                                    <div class="user-avatar xl-avatar">
                                        <?php if($upload): ?>
                                        <img class="rounded avatar-xl" src="<?php echo e($upload->temporaryUrl()); ?>" alt="change avatar" height="100" width="100">
                                        <?php else: ?>
                                        <img class="rounded avatar-xl" src="<?php echo e(auth()->user()->avatarUrl()); ?>" alt="change avatar" height="100" width="100">
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php /**PATH C:\Users\augus\Documents\Anavue frontend\anavuePortal\dashboard\resources\views/livewire/profile.blade.php ENDPATH**/ ?>