  ...
  <div class="sidebar-inner px-2 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        ...
        <div class="d-block">
          <h2 class="h5 mb-3">Hi, Jane</h2>
          <a href="{{ route('sign-in') }}" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-dashboard">
          <span>
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'dashboard' || Request::segment(1) == 'traffic-sources' || Request::segment(1) == 'app-analysis' ? 'show' : '' }}" role="list" id="submenu-dashboard" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'dashboard' ? 'active' : '' }}">
              <a href="{{ route('dashboard') }}" class="nav-link">
                <span class="sidebar-text-contracted">O</span>
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'bootstrap-tables' || Request::segment(1) == 'datatables' ? 'show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'datatables' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('datatables') }}">
                <span class="sidebar-text-contracted">D</span>
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse {{ Request::segment(2) == 'profile' || Request::segment(2) == 'pricing' || Request::segment(2) == 'invoice' ? 'show' : '' }}" role="list" id="submenu-pages" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('profile-example') }}">
                <span class="sidebar-text-contracted">P</span>
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse {{ Request::segment(2) == 'buttons' || Request::segment(2) == 'notifications' || Request::segment(2) == 'forms' || Request::segment(2) == 'modals' || Request::segment(2) == 'typography' ? 'show' : '' }}" role="list" id="submenu-components" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(2) == 'buttons' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('buttons') }}">
                <span class="sidebar-text-contracted">B</span>
      ...
      <!-- Hide Documentation and Upgrade -->
      <!--
      <li role="separator" class="dropdown-divider mt-4 mb-3 border-gray-700"></li>
      <li class="nav-item">
        <a href="/documentation/getting-started/overview/index.html" target="_blank" class="nav-link d-flex align-items-center">
          ...
          <span class="sidebar-text">Documentation <span class="badge bg-secondary ms-1 text-gray-800 badge-sm">v1.0</span></span>
        </a>
      </li>
      <li class="nav-item">
        <a href="https://themesberg.com/product/laravel/volt-pro-admin-dashboard-template" target="_blank" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
