<div>
    <title>Volt Laravel Dashboard - Single Message</title>
    <div class="row justify-content-center mt-3">
        <div class="col-12 d-flex justify-content-between flex-column flex-sm-row mt-4">
            <a class="fw-bold text-dark hover:underline d-inline-flex align-items-center mb-2 mb-lg-0" href="/messages">
            ...
            <p class="text-muted fw-normal small">Messages starting from 10th of June, 2020</p>
        </div>
        <div class="col-12">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-block text-left d-sm-block">
                                    ...
                                    <div class="text-gray small pe-3 pe-lg-11 d-none d-md-inline">Supported files are: jpg, jpeg, png, doc, pdf, gif, zip, rare, tar, txt, xls, docx, xlsx, odt
                                    </div>
                                </div>
                            </div>
                        </div>
