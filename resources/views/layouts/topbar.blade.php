    ...
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav align-items-center">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center mt-2 py-0" data-bs-popper="none">
            <div class="list-group list-group-flush">
              <a href="#" class="text-center text-primary fw-bold border-bottom border-light py-3">Notifications</a>
              <a href="/single-message" class="list-group-item list-group-item-action border-bottom">
        ...
        <li class="nav-item dropdown ms-lg-3">
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown"
            ...
            <div class="media d-flex align-items-center">
              <img class="avatar rounded-circle" alt="Image placeholder"
                src="{{ auth()->user()->avatarUrl() ? auth()->user()->avatarUrl() : '/assets/img/team/profile-picture-5.jpg'}}">
          ...
          {{-- <div class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center"> --}}
            {{-- <ul class="dropdown-menu d-flex mx-0 shadow w-220px" data-bs-theme="dark">
              <li>
          ...
          {{-- <div id="dropdown-user" class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1" data-bs-popper="none">
            <a class="dropdown-item d-flex align-items-center" href="{{ route('profile') }}"><svg
              ...
              <a class="dropdown-item d-flex align-items-center" href="{{ route('role-management') }}"><svg
               class="bi bi-people-fill mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"></path>
            </svg>Access Management</a>
            <div role="separator" class="dropdown-divider my-1"></div>
            <a id= "logout" class="dropdown-item rounded-bottom fw-bold">
              <livewire:auth.logout /></a>
          </div> --}}
        {{-- </li>
      </ul>
...
{{-- <li class="nav-item {{ Request::segment(1) == 'role-management' ? 'active' : '' }}">
  <a href="{{ route('role-management') }}" class="nav-link">
    ...
    <span class="sidebar-text">IAM</span>
  </a>
</li> --}}
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown ms-lg-3">
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="media d-flex align-items-center">
              <img class="avatar rounded-circle" alt="Image placeholder" src="{{ auth()->user()->avatarUrl() ? auth()->user()->avatarUrl() : '/assets/img/team/profile-picture-5.jpg'}}">
              <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
          ...
          <ul id="profile" class="dropdown-menu dropdown-menu-end dropdown-menu-dark flex-column mx-0 shadow w-220px sm:hidden lg:flex" data-bs-theme="dark">
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="http://127.0.0.1:8000/profile" previewlistener="true">
                My Profile
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="http://127.0.0.1:8000/examples/billing" previewlistener="true">
                Billing
              </a>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="http://127.0.0.1:8000/lock" previewlistener="true">
                Lock 
              </a>
            </li>
            <li><hr class="dropdown-divider"></li>
            <li id="logout">
              <a class="dropdown-item dropdown-item-danger d-flex gap-2 align-items-center">
                <div wire:id="SFgie37rJ1LAqYig1uZo" wire:click="logout">
    ...
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown ms-lg-3">
          ...
          <ul id="profile" class="dropdown-menu dropdown-menu-end dropdown-menu-dark flex-column mx-0 shadow w-220px hidden sm:flex lg:hidden" data-bs-theme="dark">
            <li>
              <a class="dropdown-item d-flex gap-2 align-items-center" href="http://127.0.0.1:8000/profile" previewlistener="true">
                My Profile
              </a>
...
/* Fallback for hiding on small screens */
