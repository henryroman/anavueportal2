<title>Volt Laravel Dashboard - Pricing</title>
<div class="d-block py-4">
    ...
    <h2 class="h3">Choose the best plan for your business</h2>
    <p class="mb-0">Get the power, control, and customization you need to manage your team’s and organization’s projects.</p>
</div>
        ...
        <div class="row text-gray">
            <div class="col-12 pb-4">
                <div class="d-flex align-items-center justify-content-center">
                    <!-- Label -->
                    <span class="h5 fw-normal me-4 mt-2">
                        Monthly
                    </span>  
                    ...
                    <!-- Label -->
                    <span class="h5 fw-normal ms-3 mt-2">
                        Annual
                    </span>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body py-5 px-4">
                        <div class="d-flex align-items-center mb-3">
                            <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
                            <span>Users<span class="fw-bolder ms-2">20+</span></span>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
