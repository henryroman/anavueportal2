                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">{{__('Create an account')}}</h1>
                        </div>
                        <form wire:submit.prevent="register" action="#" method="POST" class="mt-4">
                            <div class="row">
                                <!-- Form -->
                                <div class="col-6 form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="first_name" id="first-name" type="text"
                                ...
                                <div class="col-6 form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3"><span
                                                class="fas fa-user"></span></span>
                                        <input wire:model.lazy="last_name" id="last-name" type="text"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select wire:model="role_id"
                                        class="form-select mb-0 @error('role_id') is-invalid @enderror" id="role"
