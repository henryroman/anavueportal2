        ...
        <div>
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                <div class="d-block mb-4 mb-md-0">
                    ...
                    <h2 class="h4">{{__('Add item')}}</h2>
                    <p class="mb-0">{{__('Your item creation template.')}}</p>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select wire:model="category_id"
                                        class="form-select mb-0 @error('category_id') is-invalid @enderror" id="category"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div wire:ignore class="">
                                            @php
                                            $selected = json_encode($this->tag_id);
                                            @endphp
                                            @php
                                            $array = [];
                                            @endphp
                        ...
                        <div class="col-12 mb-4">
                            <div class="card shadow border-0 p-0">
                                <img class="profile-cover rounded-top"
                                    src="{{ $upload ? $upload->temporaryUrl() : '/assets/img/profile-cover.jpg' }}">
                                    ...
                                    <div class="me-3">
                                        <div class="file-field">
                                            <div class="d-flex justify-content-xl-center ms-xl-3">
                                                ...
                                                @error('upload') <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                    </div>
